...
const ServicesData = [
  ...
  },
  {
    ...
    title: "Who's there",
    description:
      "The right book at the right time can transform a person forever.",
  },
  {
    id: 3,
    img: Img3,
      ...
      <div className="py-10">
        <div className="container">
          <div className="text-center mb-20 max-w-[400px] mx-auto">
           ...
           Sometimes all it takes is one book to change the direction of a person’s life. A powerful story can spark a dream, ignite a passion, or awaken a purpose that was sleeping within
            </p>
          </div>
